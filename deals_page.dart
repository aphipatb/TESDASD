  ...
  final List<Map<String, dynamic>> mockPromotions = const [
{
  ...
  'description': 'ต้มยำกุ้งแม่น้ำ + แกงรัญจวน + ไข่เจียวปูคอนโด พร้อมข้าวหอมมะลิ 2 จาน',
  'badge': 'ลด 20%',
...
},
{
  ...
  'description': 'เมื่อสั่งขนมปังหน้าใดก็ได้ 3 แผ่น รับฟรี! ปังปิ้งสังขยาไข่ 1 แผ่น',
  'badge': '3 แถม 1',
  ...
  'description': 'ผัดไทยมันกุ้งกุ้งสดห่อไข่ 2 จาน + น้ำส้มคั้นสดแท้แก้วใหญ่ 2 แก้ว',
  'badge': 'ลด 25%',
  ...
  'description': 'สั่งข้าวซอยเนื้อหรือไก่ 1 ชาม รับฟรี! ไส้อั่วเมืองเหนือทรงเครื่อง 1 จาน',
  'badge': '1 แถม 1',
  'badgeColor': Colors.green,
  'originalPrice': '140',
  'promoPrice': '80',
  ...
  'description': 'รับส่วนลดทันทีเมื่อซื้อลอดช่องน้ำกะทิ หรือชุดของฝากครบ 500 บาทขึ้นไป',
  'badge': 'ส่วนลด 100฿',
