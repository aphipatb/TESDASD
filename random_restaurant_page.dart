...
class _RandomRestaurantPageState extends State<RandomRestaurantPage>
  ...
  // ฟังก์ชันสุ่มร้านอาหารจาก Firestore ตามแท็กที่เลือก
  Future<void> _randomizeRestaurant() async {
    ...
    try {
      ...
      // จำลองเวลาสุ่มเพื่อให้มีเอฟเฟกต์หมุน
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ==========================================
              // 2. กล่องแสดงผลการสุ่ม / วงล้อจำลอง
              // ==========================================
              Expanded(
                child: Center(
                  child: _isSpinning
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    _resultRestaurant == null ? 'สุ่มร้านอาหารเลย!' : 'สุ่มใหม่อีกรอบ',
  ...
  // หน้าจอขณะกำลังสุ่ม (มีอนิเมชันกำลังค้นหา)
  ...
  // การ์ดแสดงผลลัพธ์ร้านที่สุ่มได้
                  ...
                  children: item.tags
                      .map(
                        (t) => Chip(
                          ...
                          labelStyle: const TextStyle(fontSize: 11, color: Colors.deepOrange),
