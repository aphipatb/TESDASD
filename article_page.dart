...
class _ArticlePageState extends State<ArticlePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        // ดึงข้อมูลเพียง 10 ร้านแรกเท่านั้น
        ...
        builder: (context, snapshot) {
          ...
          // แปลงข้อมูลเป็น List<RestaurantModel>
          final List<RestaurantModel> restaurants = docs.map((doc) {
            ...
            return RestaurantModel(
              ...
              images: images,
              tags: data['tags'] != null ? List<String>.from(data['tags']) : ['แนะนำ'],
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // ==========================================
                // 1. แบนเนอร์หัวข้อหลัก (Header Banner)
                // ==========================================
                Stack(
                  children: [
                    Container(
                ...
                // ==========================================
                // 3. หมวดหมู่ทางลัด (Quick Filters)
                // ==========================================
                ...
                // ==========================================
                // 4. ส่วนที่ 1: เทรนด์มาแรง
                // ==========================================
                if (_selectedCategory == 'ทั้งหมด' || _selectedCategory == 'เทรนด์มาแรง') ...[
                ...
                // ==========================================
                // 5. ส่วนที่ 2: กำลังเป็นที่นิยม
                // ==========================================
                if (_selectedCategory == 'ทั้งหมด' || _selectedCategory == 'กำลังเป็นที่นิยม') ...[
                  _buildSectionHeader('กำลังเป็นที่นิยม'),
                  _buildPromoCard(), // ส่วนแบนเนอร์โปรโมชันร้านอาหารชั้นนำ
                  const SizedBox(height: 16),
                ...
                // ==========================================
                // 6. ส่วนที่ 3: บรรณาธิการแนะนำ
                // ==========================================
                if (_selectedCategory == 'ทั้งหมด' || _selectedCategory == 'บรรณาธิการแนะนำ') ...[
                ...
                // ==========================================
                // 7. ส่วนที่ 4: รายการ 10 อันดับร้านแนะนำ
                // ==========================================
                ...
                if (restaurants.isEmpty)
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildCompactRestaurantRow(context, item, index + 1);
                    },
                  ),
  ...
  // 🛠️ ปรับเปลี่ยนจาก KTC X CHOPE เป็นดีลส่วนลดร้านอาหารทั่วไป
  ...
  Widget _buildCompactRestaurantRow(BuildContext context, RestaurantModel item, int index) {
    String image = item.images.isNotEmpty ? item.images[0] : '';
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
